...
The downloaded binary packages are in C:\Users\tskam\AppData\Local\Temp\RtmpmUQpBG\downloaded\_packages package 'gapminder' successfully unpacked and MD5 sums checked

The downloaded binary packages are in C:\Users\tskam\AppData\Local\Temp\RtmpmUQpBG\downloaded\_packages package 'transformr' successfully unpacked and MD5 sums checked package 'gganimate' successfully unpacked and MD5 sums checked

The downloaded binary packages are in C:\Users\tskam\AppData\Local\Temp\RtmpmUQpBG\downloaded\_packages
...
### 4.4.1 **Building an animated bubble plot: `plot_ly()`method**
