...
we will install and launch **corrplot**, **ggpubr**, **plotly** and **tidyverse** in RStudio.
...
### 2.2 Importing and Preparing The Data Set

We will use [Wine Quality Data Set](https://archive.ics.uci.edu/ml/datasets/wine+quality) of UCI Machine Learning Repository data set. The data set consists of 13 variables and 6497 observations. For the purpose of this exercise, we have combined the red wine and white wine data into one data file. It is called wine_quality and is in csv file format.
...
corrplot(wine.cor,
         ...
         #number.digits = 2,
         #number.cex = 0.75,
         title="\nCorrelation Plot with Ellipses and Clusters")
```
:::
