...
We will install and launch **seriation**, **heatmaply**, **dendextend** and **tidyverse** in RStudio.
...
### 3.1 Heatmap() of R Stats - Base Stats
...
#### 4.4.1 Optimal Leaf Ordering (OLO)
