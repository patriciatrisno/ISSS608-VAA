...
subtitle: "Visualising and Analysing Network Data with R"
description: ""
...
![](images/HO%205%20img1.jpg)

### 3.2 The nodes data

-   *GAStech_email_nodes.csv* which consist of the names, department and title of the 55 employees.

![](images/HO%205%20img2.jpg){width="764"}
...
::: callout-note
Recommended to review to reference guide of [`tbl_graph()`](https://tidygraph.data-imaginist.com/reference/tbl_graph.html)
:::
...
In this section, we will use [*theme_graph()*](https://ggraph.data-imaginist.com/reference/theme_graph.html) to remove the x and y axes. Before we get started, it is recommended to read it's reference guide at least once.
...
![](images/HO%205%20img5.jpg.png) ![](images/HO%205%20img6.jpg.png)
...
Visit [Option](http://datastorm-open.github.io/visNetwork/options.html) to find out more about vis Option's argument.
